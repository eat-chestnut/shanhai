...
use App\Repositories\ChallengeRuntimeRepository;
...
use App\Repositories\IdleRuntimeRepository;
...
class AppServiceProvider extends ServiceProvider
{
    public function register(): void
    {
        ...
        $this->app->bind(ChallengeRuntimeRepositoryInterface::class, ChallengeRuntimeRepository::class);
        ...
        $this->app->bind(IdleRuntimeRepositoryInterface::class, IdleRuntimeRepository::class);

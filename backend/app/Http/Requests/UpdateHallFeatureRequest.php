...
class UpdateHallFeatureRequest extends FormRequest
{
    ...
    {
        $hallFeature = $this->route('hallFeature') ?? $this->route('hall_feature');
        ...
        return [
            'feature_id' => [
                ...
                'string',
                'max:100',
                Rule::unique('hall_features', 'feature_id')->ignore($hallFeature?->id),
            ],
